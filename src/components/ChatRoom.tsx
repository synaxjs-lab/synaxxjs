...
export const ChatRoom: React.FC<ChatRoomProps> = ({
  ...
  // Presence = visible SYNAX chat only.
  // A background/hidden SYNAX tab becomes offline immediately and heartbeats stop.
  useEffect(() => {
    ...
    const syncPresence = () => {
      ...
      void ApiService.setChatPresence(isChatVisible);
    ...
    const handleVisibility = () => syncPresence();
    ...
    return () => {
      ...
      // Best-effort immediate offline update when leaving the chat.
      void ApiService.setChatPresence(false);
    };
  }, [currentUser.id]);
